...
def main() -> None:
    required = [
        ...
        "configs/wine_pi_protocol.json",
        "scripts/run_wine_pi.py",
        "scripts/wine_pi/prepare.py",
        "scripts/wine_pi/train.py",
        "scripts/wine_pi/evaluate.py",
        "scripts/wine_pi/pipeline.py",
        "docs/wine_prediction_intervals.md",
        "results/wine_pi_20260921/reference.json",
